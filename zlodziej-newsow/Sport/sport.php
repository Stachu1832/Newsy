...
<html lang="pl">
	...
	<main>
		...
		<div id="dane">
			<div id="tytul">Sport</div>
	<header>		
			<div class="container1">
				<a href="/Sport/1.php" target="_self"><img src="Kiwior1.jpg" class="miniaturka1" width="512" height="300" ></a>
				<div class="centered1">Kiwior znokautował kolegę z Arsenalu</div>
			</div>
			
			<div class="container2">
				<a href="/Sport/2.php" target="_self"><img src="Koszykówka1.jpg" class="miniaturka2" width="512" height="300"></a>
				<div class="centered2">Niewyobrażalna cena za koszulkę debiutanta</div>
			</div>
	</header>		
			<div class="container3">
				<a href="/Sport/3.php" target="_self"><img src="Najman1.jpg" class="miniaturka3" width="512" height="300"></a>
	...
	<footer class="stopka">
		...
		<div id="poka" style="display:none">
			...
			<form action="/komentarze.php" method="POST">            
				...
				<input type="hidden" name="id_newsa" value="8"/>
		...
		$kw2= "SELECT  autor,tresc,data FROM komentarze,newsy WHERE komentarze.id_newsa=newsy.id And komentarze.id_newsa=8 order by data DESC;";
